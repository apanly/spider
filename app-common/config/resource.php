<?php
$config['cdn_host'] = "oauth.yyabc.test";
$config['cdn_path'] = "/";
$config['cdn_boundable_host'] = "oauth.yyabc.test";
...
$config['resource_type_hash'] = 'h';

$config['cdn_pure_static_host'] = "cdnstatic.yyabc.test";
$config['cdn_pure_static_path'] = "/";

$config['cnd_display_host']="oauth.yyabc.test";
